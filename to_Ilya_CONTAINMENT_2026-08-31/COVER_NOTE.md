...
**Stenberg side · with Claude. Status: SEALED 2026-08-31 (PREPARED-NOT-SENT;
the send is Selina's word and is recorded in the registry when made).**
Package: this cover note + the four verifiers with their logs + the blind
second-engine output and the two-engine diff + registry snapshot v0.28 +
SHA256SUMS.txt. Answers: your both-shadows confirmation + containment go,
