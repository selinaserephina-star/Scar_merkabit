...
or re-run. v0.3 (2026-09-11) adds §§7.8–7.13 — the shared grammar, the
reversal theorem, the D₅ anomaly and homomesy, the reverser and the
grammar, the anomaly by hand with the doubled clock, and the clock's
...
A fourth search (Balashov, 2026-09-10), following the full citation trail
of Rush–Shi (2013) on zbMATH Open (30 citing documents, all read), found
the same: no stated or proved instance of rowmotion itself being a Weyl
group element under any condition, and no per-pair parity rule. Two
adjacent results are cited for the specialist reader's benefit:
Marczinzik–Thomas–Yıldırım (2024) study a homological "Coxeter matrix"
(built from the incidence algebra's Cartan matrix) alongside rowmotion,
proving a different commutation identity than anything here; Panyushev
gives a bijection indexing order ideals by Weyl group elements, not an
identity between rowmotion and one. The same "not found" status is
...
No claim of novelty for §§7.8–7.13 beyond "not found" (§7.4, four
searches); the toggle-size homomesy of §7.10 is Defant–Hopkins–Poznanović–
...
Added in v0.3 (§§7.8–7.13), sent in envelopes of 2026-09-09..11 and awaiting
the second author's word: SM-057 (Stone AS, 14/14), SM-058 (Stone AT, 7 + 4
inverted or corrected), SM-059 (Stone AU, 10/10), SM-060 (Stone AV, 9 + 4),
